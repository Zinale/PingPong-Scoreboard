...
ALLOWED_IPS = ["192.168.0.248","127.0.0.1"]
state = {
    "player1": 0,
    "player2": 0,
    "set1":0,
...
def limit_remote_addr():
    if request.remote_addr not in ALLOWED_IPS and request.method == "POST":
        return jsonify({"ok": False, "error": "Forbidden. WHO F*CK ARE U?"}), 403

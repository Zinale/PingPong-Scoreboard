...
void loop() {
  ...
  if (buttonPressed(btn1_plus)) {Serial.println("Cliccato 1!"); score1++; sendScores();tone(10,1000,1000);}
  if (buttonPressed(btn1_minus) && score1 > 0) { score1--; sendScores();  tone(10,1000,1000); }
  if (buttonPressed(btn2_plus)) {Serial.println("Cliccato 2!"); score2++; tone(11,1000,1000);  sendScores(); }

...
const int melodyFieldAlert[] = {
  NOTE_C5, NOTE_G4, NOTE_G4, NOTE_A4, NOTE_G4, 0, NOTE_B4, NOTE_C5,
  NOTE_C5, NOTE_B4, NOTE_A4, NOTE_G4, NOTE_F4, NOTE_F4, NOTE_E4, NOTE_D4,
  NOTE_E4, NOTE_F4, NOTE_G4, 0, NOTE_G4, NOTE_C5, NOTE_B4, NOTE_A4,
  NOTE_A4, NOTE_G4
};
const short int noteDurationsFieldAlert[] = {
  4, 8, 8, 4, 4, 4, 4, 2,
  4, 8, 8, 4, 4, 4, 4, 2,
  4, 4, 2, 4, 8, 8, 4, 4,
  4, 2
